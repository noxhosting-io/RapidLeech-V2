...
//Security feature to prevent downloading of files above $options['download_dir']
if(count(explode('../', base64_decode($_GET['file']))) > count(explode('../',$options['download_dir'])))
	die('Access Denied');
