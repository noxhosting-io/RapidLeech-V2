...
if($_POST['Submit'] == 'Rename')
{
	...
	{
		$old_name = '../../'.$options['download_dir'].'/'.base64_decode($_GET['folder']).'/'.base64_decode($_GET['item_name']);
		$new_name = '../../'.$options['download_dir'].'/'.base64_decode($_GET['folder']).'/'.$_POST['new_name'];
