...
require('config.php');
$image_path = ($listing_mode == 0) ? "../".rawurldecode($_GET['image_path']) : 'ftp://'.$ftp_username.':'.$ftp_password.'@'.$ftp_host.$options['download_dir'].substr(rawurldecode($_GET['image_path']),1);
