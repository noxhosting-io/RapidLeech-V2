...
// Set page title for bootstrap template
$page_title = 'Online Video Player';

// Include bootstrap header template
...
// Use bootstrap template structure instead of custom HTML
echo "<center><h2>Online Video Player</h2></center><br />";
...
function ShowForm($err = false) {
	...
	if ($err) {
		// Include bootstrap footer before exit
		echo "</div>\n</center>\n";
