...
// PHP 8 compatible function updates
...
// Updated cut_str function for PHP 8 (keeping the more robust version)
...
// PHP 8 compatible magic quotes handling
function handle_magic_quotes($value) {
    // Magic quotes removed in PHP 8, so just return the value
    return $value;
}
...
// REMOVE THE DUPLICATE cut_str() FUNCTION THAT WAS AT LINE 112
// The function is already declared above at line 17
...
// Add this function to detect Plesk/Nginx environment
function is_behind_proxy() {
    return isset($_SERVER['HTTP_X_FORWARDED_FOR']) || 
           isset($_SERVER['HTTP_X_REAL_IP']) || 
           isset($_SERVER['HTTP_X_FORWARDED_PROTO']) ||
           (isset($_SERVER['SERVER_SOFTWARE']) && stripos($_SERVER['SERVER_SOFTWARE'], 'nginx') !== false);
}
