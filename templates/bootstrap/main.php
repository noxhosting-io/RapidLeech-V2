            ...
            <td valign="top">
                <div style="width: 131px;">
                    <div class="panel panel-primary hidden-xs">
                        <div class="panel-heading" data-toggle="collapse" data-target="#plugins" style="cursor: pointer;">
                            <h4>Plugins <span class="glyphicon glyphicon-chevron-down pull-right"></span></h4>
                        </div>
                        <div id="plugins" class="list-group collapse">
                            <div class="pre-scrollable-plugin-list">
                                <?php
                                ksort($host);
                                foreach ($host as $site => $file) {
                                    echo '<a href="#" class="plugin-item" onclick="return false;">' . $site . '</a>';
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    ?>
                        <div class="panel panel-primary hidden-xs">
                            <div class="panel-heading" data-toggle="collapse" data-target="#premium-plugins" style="cursor: pointer;">
                                <h4>Premium Host <span class="glyphicon glyphicon-chevron-down pull-right"></span></h4>
                            </div>
                            <div id="premium-plugins" class="list-group collapse">
                                <div class="pre-scrollable-plugin-list">
                                    <?php
                                    foreach ($premium_acc as $serverName => $value) {
                                        echo '<a href="#" class="plugin-item" onclick="return false;">' . str_replace('_', '.', $serverName) . '</a>';
                                    }
                                    ?>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><h4>Automation tools</h4></div>
                        <div class="list-group">
                            <?php if (!$options['auto_upload_disable']) : ?><a class="list-group-item" target="_blank" href="auul.php">Auto Upload</a><?php endif; ?>
                            <?php if (!$options['auto_download_disable']) : ?><a class="list-group-item" target="_blank" href="audl.php">Auto TransLoad</a><?php endif; ?>
                            <a class="list-group-item" target="_blank" href="mtn.php">Movie Thumbnailer</a>
                            <a class="list-group-item" target="_blank" href="dirLIST.php">DirList</a>
                            <a class="list-group-item" target="_blank" href="video.php">Video Player</a>
                            <?php if (!$options['notes_disable']) : ?><a class="list-group-item" target="_blank" href="javascript:openNotes();">Notes</a><?php endif; ?>
                        </div>
                    </div>
                </div>
                </td>
                        ...
                        <div class="container">
                            <div class="navbar-header">
                                <a href="../" class="navbar-brand navbar-brand-logo">
                                    <img src="templates/bootstrap/images/new_logo.png" alt="Rapidleech">
                                </a>
                            ...
                            <div class="navbar-collapse collapse" id="navbar-main">
                                <ul class="nav navbar-nav">
                                    <li><a href="javascript:switchCell(1);">Main Window</a></li>
                                    <li><a href="javascript:switchCell(2);">Settings</a></li>
                                    <li><a href="javascript:switchCell(3);">Server Files</a></li>
                                    <li><a href="javascript:switchCell(4);">Link Checker</a></li>
                                </ul>
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a href="#" id="theme-toggle" title="Toggle Light/Dark Theme"><span class="glyphicon glyphicon-adjust"></span></a></li>
                                    <li><a href="https://noxhosting.io/aboutus">About Us</a></li>
                                    <li><a href="https://noxhosting.io/contact">Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
<tbody>
<tr> 
<td align="center"><div class="jumbotron tab-pane fade in" id="main">
...
<tr>
<td align="left">
<b><legend><?php echo lang(207); ?>:</legend></b><br />&nbsp;<input type="text" class="form-control input-lg" name="link" id="link" placeholder="Paste your link here" size="50" /><br />
<b><legend><?php echo lang(208); ?>:</legend></b><br />&nbsp;<input type="text"  class="form-control input-lg" name="referer" id="referer" size="50" />
</td>
<td align="center"><div class="btn-group"></b>
<input value="<?php echo lang(209); ?>" class="btn btn-primary form-control"  type="<?php echo ($options['new_window'] && $options['new_window_js']) ? 'button" onclick="new_transload_window();' : 'submit'; ?>" />
</td>
</tr>
<tr>  
<td align="left"><input type="checkbox" name="user_pass" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('usernpass').style.display=displ;" value="on" /><legend>&nbsp;<?php echo lang(210); ?></legend></td>
</tr>
<tr id="usernpass" style="display: none;">
<td align="center">
<legend><?php echo lang(211); ?>:</legend> <input type="text" name="iuser" value="" /><br />
<legend><?php echo lang(212); ?>:</legend> <input type="text" name="ipass" value="" />
</td>
</tr>
<tr>
<td align="left"><input type="checkbox" name="add_comment" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('comment').style.display=displ;" />&nbsp;<legend><?php echo lang(213); ?></legend></td>
</tr>
...
<tr>
<td align="left">
<small style="color:#55bbff"><legend><?php echo lang(214); ?>:</legend></small><hr />
<label><input type="checkbox" name="dis_plug" />&nbsp;<small><legend><?php echo lang(215); ?></legend></small></label>
</td>
</tr>
<tr>
<td align="left">
<label><input type="checkbox" name="cookieuse" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('cookieblock').style.display=displ;" />&nbsp;<small><legend><?php echo lang(235); ?></legend></small></label>
<table width="150" border="0" id="cookieblock" style="display: none;">
<tr><td><legend><?php echo lang(236); ?>;</legend></td><td><input type="text" name="cookie" id="cookie" size="25" value="" /></td></tr>
</table>
</td>
</tr>
</tbody>
...
<td>
<input id="splitchkbox" type="checkbox" name="split" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('methodtd').style.display=displ;"<?php echo isset($_COOKIE["split"]) ? ' checked="checked"' : ''; ?> />&nbsp;<legend><?php echo lang(239); ?></legend>
</td>
<td>&nbsp;</td>
<td id="methodtd"<?php echo isset($_COOKIE["split"]) ? '' : ' style="display: none;"'; ?>>
<table>
<tr>
<td><legend><?php echo lang(240); ?>:</legend>&nbsp;<select name="method"><option value="tc"<?php echo isset($_COOKIE["method"]) && $_COOKIE["method"] == "tc" ? " selected" : ""; ?>><legend><?php echo lang(241); ?></legend></option><option value="rfc"<?php echo isset($_COOKIE["method"]) && $_COOKIE["method"] == "rfc" ? ' selected="selected"' : ''; ?>><legend><?php echo lang(242); ?></legend></option></select></td>
</tr>
<tr>
<td><?php echo lang(243); ?>:&nbsp;<input type="text" name="partSize" size="2" value="<?php echo isset($_COOKIE["partSize"]) && is_numeric($_COOKIE["partSize"]) ? $_COOKIE["partSize"] : 10; ?>" />&nbsp;<legend><?php echo lang(244); ?></legend></td>
</tr>
</table>
</td>
</tr>
<tr>
<td><input type="checkbox" id="useproxy" name="useproxy" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('proxy').style.display=displ;"<?php echo isset($_COOKIE["useproxy"]) ? ' checked="checked"' : ''; ?> />&nbsp;<legend><?php echo lang(245); ?></legend></td>
<td>&nbsp;</td>
<td id="proxy"<?php echo isset($_COOKIE["useproxy"]) ? '' : ' style="display: none;"'; ?>>
<table width="150" border="0">
<tr><td><legend><?php echo lang(246); ?>:</legend>&nbsp;</td><td><input type="text" name="proxy" id="proxyproxy" size="20"<?php echo !empty($_COOKIE["proxy"]) ? ' value="'.$_COOKIE["proxy"].'"' : ''; ?> /></td></tr>
<tr><td><legend><?php echo lang(247); ?>:</legend>&nbsp;</td><td><input type="text" name="proxyuser" id="proxyuser" size="20"<?php echo !empty($_COOKIE["proxyuser"]) ? ' value="'.$_COOKIE["proxyuser"].'"' : ''; ?> /></td></tr>
<tr><td><legend><?php echo lang(248); ?>:</legend>&nbsp;</td><td><input type="text" name="proxypass" id="proxypass" size="20"<?php echo !empty($_COOKIE["proxypass"]) ? ' value="'.$_COOKIE["proxypass"].'"' : ''; ?> /></td></tr>
</table>
</td>
</tr>
<tr>
...
<tr>
<td><input type="checkbox" name="premium_acc" id="premium_acc" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('premiumblock').style.display=displ;"<?php if (count($premium_acc) > 0) print ' checked="checked"'; ?> />&nbsp;<legend><?php echo lang(249); ?></legend></td>
<td>&nbsp;</td>
<td id="premiumblock" style="display: none;">
<table width="150" border="0">
<tr><td><legend><?php echo lang(250); ?>:</legend>&nbsp;</td><td><input type="text" name="premium_user" id="premium_user" size="15" value="" /></td></tr>
<tr><td><legend><?php echo lang(251); ?>:</legend>&nbsp;</td><td><input type="password" name="premium_pass" id="premium_pass" size="15" value="" /></td></tr>
</table>
</td>
</tr>
<tr>
...
<td><?php echo link_for_file($file["name"], FALSE, 'class="flist-file-name"'); ?></td>
...
<span id="loading" style="display: none;">
      &nbsp;&nbsp;
      <?php echo lang(273); ?>
      <img alt="<?php echo lang(274); ?>" src="templates/bootstrap/images/ajax-loading.gif" name="pic1" />    </span>
<div align="center">
